...
rule basic_complete:
    ...
    params:
        ...
        dir_to_move_telescope = config['efs_dir_telescope'],  # "/efs/projects/burkitt_lymphoma_TE_atlas/results/telescope/"
        dir_to_move_star = config['efs_dir_star'] # "/efs/projects/burkitt_lymphoma_TE_atlas/results/star_alignment/"
    shell:
        """
